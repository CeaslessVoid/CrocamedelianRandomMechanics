...
{
    public class QuestNode_GetNearbyPirateSettlement : QuestNode_GetNearbySettlement
    {
        ...
        private Settlement RandomNearbyTradeableSettlement(int originTile, Slate slate)
        {
            ...
            {
                if (settlement.Faction == Faction.OfPlayer || !settlement.Faction.def.permanentEnemy)
                {
                    return false;
                }
