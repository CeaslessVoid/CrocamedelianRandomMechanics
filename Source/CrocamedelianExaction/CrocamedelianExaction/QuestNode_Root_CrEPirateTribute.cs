...
//            //{
//            //    if (innerContainer[i].def == CrE_DefOf.ChastityCage)
//            //    {
...
//            //for (int j = 0; j < 2; j++)
//            //{
//            //    ThingDef stuffDef = ThingDef.Named("Steel");
//            //    innerContainer.TryAdd(ThingMaker.MakeThing(CrE_DefOf.ChastityCage, stuffDef), 1, true);
//            //}
...
//                {
//                    //PawnDuty pawnDuty = new PawnDuty(CrE_DefOf.Make_Tribute, target, spot);

//                    //PawnDuty pawnDuty = new PawnDuty(DutyDefOf.Idle);
//                    //pawnDuty.focus = spot;
//                    //pawn.mindState.duty = pawnDuty;

//                    Job tributeJob = JobMaker.MakeJob(CrE_DefOf.CrE_ApplyTattooTribute, target);
//                    tributeJob.targetA = target;

//                    pawn.jobs.TryTakeOrderedJob(tributeJob);
...
//                    PawnDuty duty = new PawnDuty(CrE_DefOf.Get_Raped, spot);
...
//            //    Thing thing = innerContainer.First((Thing t) => t.def == CrE_DefOf.ChastityCage);
//            //    innerContainer.Remove(thing);
//            //    thing.Destroy();

//            //    ThingDef stuffDef = ThingDef.Named("Steel");
//            //    ThingWithComps ChastityCage = (ThingWithComps)ThingMaker.MakeThing(CrE_DefOf.ChastityCage, stuffDef);
//            //    if (ChastityCage != null)
//            //    {
//            //        target.apparel.Wear((Apparel)ChastityCage, dropReplacedApparel: true);
//            //    }

//            //    Hediff chastityHediff = HediffMaker.MakeHediff(HediffDef.Named("CrE_Chastity"), target);
//            //    target.health.AddHediff(chastityHediff);
//            //}
...
//            Find.LetterStack.ReceiveLetter("OutcomeLetterLabel".Translate(outcome.label.Named("OUTCOMELABEL"), "CrETributeCeremony".Translate().Named("RITUALLABEL")), text2, LetterDefOf.RitualOutcomeNegative, target);
